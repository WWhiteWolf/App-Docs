...
3. **A Place To Remember (Memory) — iPhone** — Alpha, and it is on his
   phone. Folder: `Projects/elderlyassistant`. Status: #109-new
   (2026-09-13). Build 81 on the phone. The designed-machine sheet is
   complete in the project, not on that load: 402 checks pass and
   TypeScript is clean. Native phone proof remains. Testers on

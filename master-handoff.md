...
3. **A Place To Remember (Memory) — iPhone** — Alpha, and it is on his
   phone. Folder: `Projects/elderlyassistant`. Status: #96-new
   (2026-09-09). Easiest-and-best look; Log off the list. Two leftovers
   for the next sitting: way back to none, and distinct Home pictures
   for Appointments and Bucket List. Phone still the #82-new load.

...
3. **A Place To Remember (Memory) — iPhone** — Alpha, and it is on his
   phone. Folder: `Projects/elderlyassistant`. Status: #89-new
   (2026-09-08). Calendar through Options in the spec. Spec only; not
   on the phone. Next sitting is exclusive groups on the translator's
   table; do not change the scheduler's decisions. Phone still the
   #82-new load. Testers on TestFlight; App Store 72 waiting for review,
   manual release, not aiming to go live.

...
3. **A Place To Remember (Memory) — iPhone** — Alpha, and it is on his
   phone. Folder: `Projects/elderlyassistant`. Status: #105-new
   (2026-09-11). Build 80 on the phone. Issue fixes in the project, not
   on 80. Next sitting: six User's Guide headings together. Testers on
